...
int main(int argc, char **argv)
{
    ...
    // 连接服务器成功，启动接收子线程
    std::thread readTask(readTaskHandler, clientfd); // phtread_create
    ...
    for (;;)
    {
        ...
        case 1: // login业务
        {
            ...
            sem_wait(&rwsem); // 等待信号量，由子线程处理完响应消息后，通知这里
...
void mainMenu(int clientfd)
{
    ...
    while (isMainMenuRunning)
    {
        ...
        it->second(clientfd, commandbuf.substr(idx + 1, commandbuf.size() - idx)); // 调用命令处理函数
    }
}
